...
from liveStream.models import LiveStream, ContactDetail, ContactDetailFDP
from django.utils.html import format_html

# Register your models here.
class LiveStreamAdmin(admin.ModelAdmin):
    list_display = ('title', 'stream_key', 'collect_details', 'fdp_details', 'export_url')
...
admin.site.register(ContactDetailFDP)
